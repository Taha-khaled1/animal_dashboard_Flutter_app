...
class _AddProductState extends State<AddProduct> {
  String? name, nameen, des, desen, price, kmia, hagm;
  bool isload = false;
...
// Function to pick an image
  ...
  Future<bool> registerUser() async {
    ...
    final String url = 'https://elegantae.net/api/vendor-account/product';
    ...
    request.fields['category_id'] = 1.toString();
              ...
              child: Form(
                ...
                child: Column(
                  children: [
                    ...
                    CustomTextfeild(
                      text: 'اسم المنتج اللغه الانجليزيه',
                      valid: (value) {
                        return validInput(value.toString(), 3, 100, "type");
                      },
                      onsaved: (value) {
                    ...
                    CustomTextfeild(
                      text: 'سعر المنتج',
                      valid: (value) {
                        return validInput(value.toString(), 1, 10, "type");
                      },
                      onsaved: (value) {
